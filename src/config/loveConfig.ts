...
export const loveConfig = {
  ...
  heroSubtext: "I was thinking today about how lucky I am that, after all this time, you're still the only person I truly want to be close to. There’s a specific kind of magic in the way we know each other. The way you know exactly what I’m thinking before I say it, and that effortless pull I feel toward you every moment I see you. You are my greatest addiction, and I’m looking forward to a very long intentional night of showing you exactly what you mean to me.",
