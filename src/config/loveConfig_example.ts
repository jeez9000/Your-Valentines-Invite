...
export const loveConfig = {
  ...
  milestones: [
    ...
    {
      title: "Birthday and Meeting Family",
    ...
    },
    {
      ...
      date: "June 20, 2024",
      description: "One of my favorite nights — the city glowing beneath us, smoke drifting into the air, your lips meeting mine like we had nowhere else to be.In that moment, everything felt slower, more intense, like time itself respected what we were building"
    },
    {
